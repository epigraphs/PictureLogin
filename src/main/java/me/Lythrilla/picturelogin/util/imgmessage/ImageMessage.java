package me.Lythrilla.picturelogin.util.imgmessage;
    ...
    private String[] toImgMessage(ChatColor[][] colors, char imgchar) {
        ...
        for (int y = 0; y < colors[0].length; ++y) {
            ...
            for (int x = 0; x < colors.length; ++x) {
                ...
                line = (String)line + String.valueOf(color != null ? colors[x][y].toString() + imgchar : Character.valueOf(' '));
            }
            this.lines[y] = (String)line + String.valueOf(ChatColor.RESET);
        }
        return this.lines;
    }
